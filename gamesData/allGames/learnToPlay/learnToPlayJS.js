...
dom.randomBtnChoise.classList.remove('far');
const delBtn = () => {
    dom.icone.classList.remove('far');
    dom.randomBtnChoise.classList.add('far');
    ...
    for (i = arr.length - 1; i >= 0; i--) {
        ...
        if (element == arrRandomOnly[i]) {
            ...
            arr.map(item => {
                ...
                setTimeout(() => {
                    drawSingleTav(bag, dom.bbagContiner);
                }, 1200 * i);
                console.log('ok')
            })
